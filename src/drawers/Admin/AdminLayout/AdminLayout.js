...
const AdminLayout = ({ navigation }) => {
  ...
  const confirmThemeSelection = async () => {
    ...
    try {
      ...
      setLoading(false);
      navigation.navigate(selectedTheme, { empId: empId });
      Toast.show({
        type: "success",
      ...
      <View style={styles.scrollViewContainer}>
        <ScrollView horizontal={true} contentContainerStyle={styles.scrollView}>
          {/*<TouchableOpacity
            ...
            onPress={() => handleSelectTheme("AdminTheme1")}
          >
          ...
          <TouchableOpacity
            style={styles.imageContainer}
            onPress={() => handleSelectTheme("AdminTheme2")}
          >
          ...
          <TouchableOpacity
            style={styles.imageContainer}
            onPress={() => handleSelectTheme("AdminTheme3")}
          >
         ...
         {/* <TouchableOpacity
            style={styles.imageContainer}
            onPress={() => handleSelectTheme("AdminTheme4")}
          >
          ...
          {/*<TouchableOpacity
            style={styles.imageContainer}
            onPress={() => handleSelectTheme("AdminTheme5")}
          >
          ...
          <TouchableOpacity
            style={styles.imageContainer}
            onPress={() => handleSelectTheme("AdminTheme6")}
          >
          ...
          <View style={styles.modalView}>
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={[
                  styles.modalBtn,
                  { width: width * 0.4, backgroundColor: "#8339FF" },
                ]}
