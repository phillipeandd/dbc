...
const ATheme6 = ({ navigation }) => {
  ...
  const text = `${seeUser?.data?.user?.user_details?.headline
        ...
        <View style={styles.header}>
          {seeUser && seeUser?.user?.userImage ? (
            <View style={styles.avatarContainer}>
              ...
              />
              <Image
                source={require('../../../../assets/social/speclogo.png')} // Replace with your logo image
                style={styles.logo}
              />
            </View>
          ) : (
        ...
        <View style={styles.infoContainerIn}>
          ...
          >
            <View style={styles.content}>
              <Text style={styles.textLeft}>{seeUser?.data?.user?.user_details?.title
                ? seeUser?.data?.user?.user_details?.title
                : "Employee"}
              </Text>
              <View style={styles.divider} />
              <Text style={styles.textRight}> {seeUser?.data?.user?.user_details
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoRow}>
            ...
            <View>
              ...
              <Text style={styles.infoText}>{seeUser?.company?.website
