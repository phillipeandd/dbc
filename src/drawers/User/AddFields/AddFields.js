...
const AddFields = ({ navigation }) => {
  ...
  // const [address, setAddress] = useState(social.address);
  ...
  // const [discord, setDiscord] = useState(social.discord);
  // const [skype, setSkype] = useState(social.skype);
  // const [telegram, setTelegram] = useState(social.telegram);
  // const [reddit, setReddit] = useState(social.reddit);
  ...
  const handleAddSocial = async () => {
    try {
      ...
      const response = await fetch(
        `https://bc.exploreanddo.com/api/add-socialmedia-links/${userId}`,
  ...
  const handleDeleteSocial = async (socialMedia) => {
    ...
    try {
      setIsDelete(true);
      const response = await fetch(
        `https://bc.exploreanddo.com/api/delete-socialmedia-links/${userId}`,
        {
          method: "POST",
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        <View style={styles.row}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Add Fields")}>
            <LinearGradient
