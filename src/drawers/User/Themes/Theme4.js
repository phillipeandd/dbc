        ...
        >
          <Defs>
            <MyLinearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="0%">
              {/* <Stop offset="0%" stopColor="#702DFF" />
              <Stop offset="100%" stopColor="#702DFF" />
              <Stop offset="30%" stopColor="#702DFF" /> */}
               <Stop offset="0%" stopColor="#E7D4FC" />
              <Stop offset="100%" stopColor="#8754DE" />
              <Stop offset="30%" stopColor="#E7D4FC" />
            </MyLinearGradient>
          </Defs>
          <Path
            fill="url(#grad)"
