  ...
  const updateFunction = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://bc.exploreanddo.com/api/edit-user-image/${userId}`,
        {
          method: "POST",
          headers: {
      ...
      <View style={styles.content}>
        ...
        >
          ...
          {userImage ? (
            ...
            <>
              ...
              onPress={() => setShowUserImageModal(true)}
            >
              <MaterialCommunityIcons name="account-edit" size={40} color="#702DFF" style={{ textAlign: "center" }}/>
              <Text style={{ textAlign: "center", color: "#702DFF" }}>
                Choose
              </Text>
              <Text style={{ textAlign: "center", color: "#702DFF" }}>
                Image
        ...
        {/* <View style={{ justifyContent: "center", alignItems: "center" }}>
          <TouchableOpacity
            style={[
              styles.button,
              { backgroundColor: "#702DFF", width: width * 0.9 },
            ]}
